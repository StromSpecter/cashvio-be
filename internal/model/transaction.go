...
type CreateTransactionRequest struct {
	...
	Category    string    `json:"category" binding:"required,oneof=salary freelance gift bonus food transportation housing pets shopping entertainment health education income transfer groceries subscription travel"`
...
type UpdateTransactionRequest struct {
	...
	Category    string     `json:"category" binding:"omitempty,oneof=salary freelance gift bonus food transportation housing pets shopping entertainment health education income transfer groceries subscription travel"`
	Status      string     `json:"status" binding:"omitempty,oneof=completed pending failed"`
